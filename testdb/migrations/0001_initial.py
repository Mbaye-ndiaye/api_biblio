    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, help_text='Prix du livre', max_digits=8, validators=[django.core.validators.MinValueValidator(0.0)])),
                ('cover_image', models.ImageField(blank=True, help_text='Image de couverture', null=True, upload_to='book_covers/', validators=[testdb.models.book.validate_image_type])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('membre_nom', models.CharField(blank=True, max_length=255, null=True)),
                ('livre_nom', models.CharField(blank=True, max_length=255, null=True)),
